...
function draw() {
  ...
  if(gameState === instruction) {
    ...
    text("NOW GO AND SAVE THE WORLD HERO!",canvas.width/2-450,canvas.height/2+100);
    stroke("yellow");
    fill("yellow");
    textSize(35);
    textFont("Apple Chancery");
    text("This is the year 3600 .....",canvas.width/2-400,canvas.height/2-250);
    text(" Huge asteroids are coming for our home Earth.",canvas.width/2-400, canvas.height/2 - 210);
    text("  You are a Brave Space Ranger.",canvas.width/2-400,canvas.height/2-170);
    text("  Help the people of Earth and Earth itself !",canvas.width/2-400,canvas.height/2-130);
    text("  press 'space' to shoot.",canvas.width/2-400,canvas.height/2-90);
    text("  use right and left arrows to move.",canvas.width/2-400,canvas.height/2-50);
    text("  press 's' to start game.",canvas.width/10,canvas.height/2-10);
